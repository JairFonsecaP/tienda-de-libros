...
public class Libro {
    ...
    /**
     * Busca la transaccion mas costosa
     */
    // private Transaccion transaccionMasCostosa;
    ...
    /**
     * Crea un libro con su título, isbn, autor y precioVenta. La cantidad actual  e
     * inicializa en cero y la colección de transacciones es vacía.
     * 
     ...
     * @param pRutaImagen   Ruta de la imagen del libro. pRutaImagen != null &&
     *                      pRutaImagen != "".
     */
     ...
     *                  && pFecha != null.
     * @return Retorna true en caso de que se pueda vender la cantidad que entra por
     *         parámetro. Retorna false en caso de que la cantidad sea mayor a la
     *         actual.
     */
    public boolean vender(int pCantidad, String pFecha) {
        boolean vendido = false;
        // Verifica que la cantidad que entra por parámetro sea menor o igual a la
        // cantidad igual
     ...
     * 
     * @param pCantidad La cantidad de ejemplares que se van a agregar a la cantidad
     *                  actual.
     * @param pFecha    La fecha en la que se realizó la transacción. pFecha != ""
     *                  && pFecha != null.
     */
    ...
    /**
     * actualiza el precio con el descuento segun el rango
     */
    public void actualizarPrecio(double precioModificado) {
        precioVenta = precioModificado;
    }
}
